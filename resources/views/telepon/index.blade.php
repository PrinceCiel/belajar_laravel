    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        <div class="col-md-8">
            <div class="card h-100" style="width: 70rem;">
                <div class="card-header text-primary">Data Telepon</div>
                ...
                @endif
                    <a href="{{ route('telepon.create') }}" class="btn btn-primary">Add Data</a>
                    <table class="table">
                        <thead>
                        <tr>
                            <th scope="col">No</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('telepon.edit', $data->id) }}" class="btn btn-secondary">Edit</a>
